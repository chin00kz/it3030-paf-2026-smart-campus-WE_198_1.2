                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-4">
                            {resources.map(r => (
                                ...
                                >
                                    ...
                                    <div className={`h-32 relative flex items-center justify-center overflow-hidden bg-gradient-to-br ${r.type === 'LECTURE_HALL' ? 'from-blue-600 to-indigo-700' :
                                        ...
                                        <div className="absolute top-6 right-6">
                                            <span className={`glass-morphism px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border-white/40 shadow-lg ${r.status !== 'UNAVAILABLE' ? 'text-emerald-500' : 'text-red-500'
                                                }`}>
            ...
            {selectedResource && (
                <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-in fade-in duration-500">
                    <div className="bg-white/90 backdrop-blur-xl rounded-[3rem] shadow-2xl w-full max-w-xl flex flex-col max-h-[95vh] overflow-hidden border border-white/40 animate-in zoom-in-95 duration-300">
                        <div className={`shrink-0 h-40 relative flex flex-col justify-end p-8 bg-gradient-to-br ${selectedResource.type === 'LECTURE_HALL' ? 'from-blue-600 to-indigo-700' :
                        ...
                        <div className="p-10 space-y-8 overflow-y-auto custom-scrollbar">
                            ...
                            <div className="pt-6 flex gap-5 border-t border-slate-100 shrink-0 mt-auto">
                                ...
                                <button
                                    ...
                                    className={`flex-1 px-8 py-5 rounded-2xl font-black transition-all shadow-xl uppercase tracking-[0.2em] text-xs ${selectedResource.status !== 'UNAVAILABLE'
